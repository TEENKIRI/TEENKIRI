...
public class InitialDataLoader implements CommandLineRunner {
    ...
    private void initUserData() {
        registerUserIfNotExists("admin@test", "admin", "admin", "12341234", "07012345678", Role.ADMIN,
        ...
        registerUserIfNotExists("yohan@test.com", "황요한", "[T]황요한", "testtest", "01012345678", Role.TEACHER,
                null);

        registerUserIfNotExists("yena@test.com", "이예나", "[T]이예나", "testtest", "01098765432", Role.TEACHER,
                null);
    }
    ...
    private void initEventData() {
        if (eventRepository.count() == 0) {
            User adminUser = userRepository.findByEmail("admin@test").orElseThrow(
